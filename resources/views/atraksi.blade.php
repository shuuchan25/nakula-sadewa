            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-3">
                    <ul class="nav  justify-content-center gap-5">
                        <li class="nav-item">
                            <a class="nav-link active" href="atraksi">
        ...
        <div class="tabs rounded">
            <ul class="nav nav-tabs border-0 justify-content-center gap-2">
                ...
                @foreach($categories as $category)
                    <li class="nav-item">
                        <form action="/atraksi" method="GET">
    ...
    <!-- Tab panes -->
            <div class="tab-content pt-4 pb-5">
                <div class="tab-pane container active" id="alam">
                    {{-- SEARCH --}}
                        <form action="/atraksi" method="GET" id="search-form" class="w-100">
                            @csrf
                            <div class="row mt-4">
                                <div class="col-sm mt-2 search-wisata">
                                    <div class="input-group">
                                        <input type="text" name="search" class="form-control border-end-0" value="{{ request('search') }}" placeholder="Cari Destinasi Alam">

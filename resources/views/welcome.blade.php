                                        ...
                                        <div class="card swiper-slide ">
                                            ...
                                            <div class="card-button w-100 d-flex justify-content-center">
                                                <button type="detail" class="detail-button"><a
                                                        href="kalenderevent">Lihat Detail</a></button>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                            ...
                                            <div class="card text-bg-dark">
                                                ...
                                                <div class="card-img-overlay berita-content">
                                                    <a href="beritaterkini">
                                                        <h5 class="card-title" style="margin-top: 110px">
                                                            {{ $article->title }}</h5>
                                                    </a>
                                                    <p class="card-text" style="color: white">
                                                        <small>{{ $article->published_at }}</small></p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row card-kata d-flex">
                                        ...
                                        <div class="col-8 my-auto ">
                                            <div class="teks">
                                                ...
                                                <p class="card-text">{{ Str::limit(strip_tags($story->content, 100)) }}
                                                </p>
                                                <button type="detail" class="detail-button"><a

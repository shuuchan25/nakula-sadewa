    ...
    <section class="page-section">
        ...
        <div class="page-content d-flex flex-column align-items-center">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2 w-100">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/kategori-desa-wisata/create'">Tambah Kategori</button>
                </div>
            </div>
            <div class="content-wrapper w-100">
                ...
                <div class="overflow-x-auto w-100">
                    @if ($desaWisataCategories->count() > 0)
                    <table id="table-container" class="">
                        <tr class="bg-[#F6F6F6] text-sm ">
                            <th class="col-one">Nama</th>
                            <th class="col-five">Action</th>
                        </tr>
                        @foreach ($desaWisataCategories as $desaWisataCategory)
                            <tr class="table-item">
                                <td class="">
                                    <div class="first-column">
                                            <p class="first-p">{{ $desaWisataCategory->name }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="">
                                    <div class="action-buttons">
                                        <button class="" onclick="location.href='/admin/kategori-desa-wisata/{{ $desaWisataCategory->slug }}/edit'">
                                        ...
                                        <form action="/admin/kategori-desa-wisata/{{ $desaWisataCategory->slug }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus item ini?')">
                                            @csrf
                                            @method('delete')

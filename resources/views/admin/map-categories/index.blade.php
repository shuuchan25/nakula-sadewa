    ...
    <section class="page-section">
        ...
        <div class="page-content d-flex flex-column align-items-center">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-4 pb-2 w-100">
                <div class="">
                    <p class="">Hai Admin,</p>
                    <h3 class="">Kategori Tempat</h3>
                </div>
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/map-categories/create'">Tambah Kategori</button>
                </div>
            </div>
                            ...
                            <tr class="table-item">
                                <td class="">
                                    <div class="first-column">
                                        <img src="{{ asset('storage/' . $mapCategory->image) }}" alt="" class="category-icon">
                                            <p class="first-p">{{ $mapCategory->name }}</p>
                                ...
                                <td class="">
                                    <div class="action-buttons">
                                        <button class="" onclick="location.href='/admin/map-categories/{{ $mapCategory->slug }}/edit'">
                                        ...
                                        <form action="/admin/map-categories/{{ $mapCategory->slug }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus item ini?')">
                                            @csrf
                                            @method('delete')

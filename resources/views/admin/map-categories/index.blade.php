    ...
    <section class="page-section">
        ...
        <div class="page-content d-flex flex-column align-items-center">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-4 pb-2 w-100">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/map-categories/create'">Tambah
                        Kategori</button>
                </div>
            </div>
            <div class="content-wrapper w-100">
                ...
                <td class="">
                    <div class="action-buttons">
                        <button class=""
                            onclick="location.href='/admin/map-categories/{{ $mapCategory->slug }}/edit'">
        ...
        <div class="pagination d-flex justify-content-center pt-4">
            {{ $mapCategories->links('admin.partials.custom_pagination') }}
        </div>
    </section>
@endsection

    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='add-hotel'">Tambah
                        Penginapan</button>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="item-filters">
                    ...
                    <div class="select-box">
                        <select name="kategori" id="kategori-select">
                            ...
                            <option value="wisata bahari">Penginapan Bahari</option>
                        </select>
                    </div>
                </div>
                        ...
                        <tr class="table-item">
                            <td class="">
                                <div class="first-column">
                                    <p class="first-p">Penginapan Pandean</p>
                                </div>
                </div>
                </td>
                <td class="">Hotel</td>
                ...
                <td class="">
                    <div class="action-buttons">
                        ...
                        <button class="" onclick="location.href='edit-hotel'">

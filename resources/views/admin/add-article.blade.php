                    ...
                    <form action="{{ route('article.store') }}" class="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-block d-md-flex align-items-center justify-content-between gap-3 w-100">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="title" class="" placeholder="Judul Artikel"
                                        required>
                                </div>
                            </div>
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="published_at" class="" placeholder="dd/mm/yyyy"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer w-100">
                            <button type="button" class="btn cancel-btn mb-0"
                                onclick="location.href='article'">Batal</button>

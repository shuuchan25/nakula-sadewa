    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-block d-sm-flex align-items-center justify-content-between pb-2">
                <div class="">
                    <p class="">Hai Admin,</p>
                    <h3 class="">Artikel & Berita</h3>
                </div>
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/articles/create'">Tambah
                        Artikel</button>
                </div>
            </div>
                        ...
                        <table class="" id="table-container">
                            ...
                            @foreach ($articles as $article)
                                <tr class="table-item">
                                    ...
                                    <td class=""><img src="{{ Storage::url($article->image) }}" alt=""

    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='add-destinasi-wisata'">Tambah Wisata</button>
                </div>
            </div>
                        ...
                        <tr class="table-item">
                            <td class="">
                                <div class="first-column">
                                        <p class="first-p">Desa Wisata Pandean</p>
                                    </div>
                                </div>
                            </td>
                            <td class="">Wisata Kuliner</td>
                            <td class="">
                               Alamat
                            </td>
                            <td>kontak</td>
                            <td class="">
                                <div class="action-buttons">
                                    <button class="" onclick="location.href='detail-destinasi-wisata'" >
                                    ...
                                    <button class="" onclick="location.href='edit-destinasi-wisata'">

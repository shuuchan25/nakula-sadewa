    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-3 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/stories/create'">Tambah
                        Cerita</button>
                </div>
            </div>
                    ...
                    <div class="item-filters gap-3">
                        <div class="search">
                            ...
                            <input type="text" name="search" class="" id="search-input"
                                placeholder="Cari cerita wisatawan...">
                        </div>
                        ...
                        <table class="" id="table-container">
                            ...
                            @foreach ($stories as $story)
                                <tr class="table-item">
                                    ...
                                    <td class="">
                                        <img src="{{ Storage::url($story->image) }}" alt=""
                                            style="width: 200px; border-radius: 8px;">
                                    </td>
                                    <td class="">
                                        <div class="action-buttons">
                                            <button class=""
                                                onclick="location.href='/admin/stories/{{ $story->slug }}'">
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/stories/{{ $story->slug }}/edit'">

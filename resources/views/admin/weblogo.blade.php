            ...
            <div class="content-wrapper">
                ...
                <div class="w-100 pt-3 border-top">
                    <div class="">
                        ...
                        @if (isset($weblogos) && (is_array($weblogos) || is_object($weblogos)) && count($weblogos) > 0)
                            <div class="image-list pt-3 w-100 d-flex gap-2">
                                @foreach ($weblogos as $logo)
                                    <div class="image-item">
                                        <div class="image-card">
                                            <img src="{{ asset('storage/' . $logo->image) }}" alt="">
                                        </div>
                                        <form action="{{ route('admin.weblogo.destroy', $logo->id) }}" method="POST"

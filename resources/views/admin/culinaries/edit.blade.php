        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/culinaries/{{ $culinary->slug }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $culinary->name) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $culinary->slug ) }}" required
                                ...
                                <div class="select-box">
                                    <select name="category_id" id="categorySelect">
                                        ...
                                        @foreach ($categories as $category)
                                            @if (old('category_id', $culinary->category_id ) == $category->id)
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address"
                                        class="@error('address') is-invalid @enderror" value="{{ old('address', $culinary->address ) }}"
                            ...
                            <div class="w-100 pt-3 pt-md-0" >
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour"
                                        ...
                                        value="{{ old('operational_hour', $culinary->operational_hour ) }}" required placeholder="Contoh 08.00 - 17.00">
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact"
                                        class="@error('contact') is-invalid @enderror" value="{{ old('contact', $culinary->contact) }}"
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map"
                                        class="@error('map') is-invalid @enderror" value="{{ old('map', $culinary->map) }}" required
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        class="@error('image') is-invalid @enderror" value="{{ old('image', $culinary->image) }}"
                        ...
                        <div class="d-flex w-100 gap-3 align-items-start justify-content-between">
                            <div id="image-preview-dump" class="image-list w-100 pt-2">
                            </div>
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="description" id="description" value="{{ old('description', $culinary->description ) }}">
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    <div class="modal-body add-form pb-3">
                        ...
                        @endif
                        <form action="/admin/culinary-images/{{ $culinary->id }}" method="POST"
                                ...
                                <div class="image-list pe-4 me-3 border-end">
                                    <div class="image-item ">
                                        <div class="image-card mb-1">
                                            <img src="{{ asset('storage/' . $culinary->image) }}" alt="">
                                        </div>
                                        Gambar Utama
                                    </div>
                                </div>
                                <div class="image-list pt-3 pt-md-0">
                                    @foreach ($other_images as $other_image)
                                            ...
                                            <div class="image-item">
                                                ...
                                                <form
                                                    action="{{ route('admin.culinaryimages.destroy', $other_image->id) }}"
                                                    method="POST"

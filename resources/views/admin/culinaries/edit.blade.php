            ...
            <div class="content-wrapper">
                    ...
                    <form action="/admin/culinaries/{{ $culinary->slug }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $culinary->name) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        value="{{ old('slug', $culinary->slug) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address"
                                        ...
                                        value="{{ old('address', $culinary->address) }}" required
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour"
                                        ...
                                        value="{{ old('operational_hour', $culinary->operational_hour) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact"
                                        ...
                                        value="{{ old('contact', $culinary->contact) }}" required
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map"
                                        class="@error('map') is-invalid @enderror" value="{{ old('map', $culinary->map) }}"
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        ...
                                        value="{{ old('image', $culinary->image) }}" onchange="previewImage()">
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="description" id="description"
                                value="{{ old('description', $culinary->description) }}">
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    <div class="modal-body add-form pb-3">
                        ...
                        @endif
                        <form action="/admin/culinary-images/{{ $culinary->id }}" method="POST" class=""
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2 align-items-start">
                                ...
                                @foreach ($other_images as $other_image)
                                    <div class="image-item">
                                        ...
                                        <form action="{{ route('admin.culinaryimages.destroy', $other_image->id) }}"
                                            method="POST"

        ...
        <div class="page-content">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-3 pb-2">
                ...
                <div class="">
                    @can('admin-kuliner')
                        @if (!$culinary)
                            <button type="button" class="primary-button" onclick="location.href='/admin/culinaries/create'">Tambah
                                Kuliner</button>
                        @endif
                    @endcan
                </div>
            ...
            <div class="content-wrapper">
                ...
                @endif
                @can('superadmin')
                    <form action="/admin/culinaries" method="GET" id="search-form" class="w-100">
                        <div class="item-filters">
                            <div class="search">
                                ...
                                <input type="text" name="search" class="" id="search-input"
                                    placeholder="Cari wisata kuliner" value="{{ request('search') }}">
                            </div>
                                    ...
                                    <tr class="table-item">
                                        <td class="">
                                            <div class="first-column">
                                                <p class="first-p">{{ $culinary->name }}</p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/culinaries/{{ $culinary->slug }}'">
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="">
                                        <div class="action-buttons">
                                            @can('admin-kuliner')
                                                <button class=""
                                                    onclick="location.href='/admin/culinaries/{{ $culinary->slug }}/menus/create'">
                                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('admin-kuliner')
                                                <button class=""
                                                    onclick="location.href='/admin/culinaries/{{ $culinary->slug }}/edit'">
                                                ...
                                                <form action="/admin/culinaries/{{ $culinary->slug }}" method="POST"

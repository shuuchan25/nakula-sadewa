    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-3 pb-2">
                <div class="">
                    <p class="">Hai Admin,</p>
                    <h3 class="">Edit Desa Wisata</h3>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/desa-wisata/{{ $desaWisataItem->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name" class="@error('name') is-invalid @enderror" value="{{ old('name', $desaWisataItem->name) }}" required placeholder="Nama Destinasi Wisata">
                                    @error('name')
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug" class="@error('slug') is-invalid @enderror" value="{{ old('slug', $desaWisataItem->slug) }}" required placeholder="Slug Destinasi Wisata">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="select-box w-100">
                                ...
                                <div class="select-box">
                                    <select name="category_id">
                                        ...
                                        @if(old('category_id', $desaWisataItem->category_id ) == $category->id)
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address" class="@error('address') is-invalid @enderror" value="{{ old('address', $desaWisataItem->address) }}" required placeholder="Masukkan alamat">
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour" class="@error('operational_hour') is-invalid @enderror" value="{{ old('operational_hour', $desaWisataItem->operational_hour ) }}" required placeholder="Contoh 08.00 - 17.00">
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact" class="@error('contact') is-invalid @enderror" value="{{ old('contact', $desaWisataItem->contact) }}" required placeholder="Masukkan nomor telepon">
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="number" name="price" id="price" class="@error('price') is-invalid @enderror" value="{{ old('price', $desaWisataItem->price) }}" required placeholder="Masukkan harga">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="video" id="video" class="@error('video') is-invalid @enderror" value="{{ old('video', $desaWisataItem->video) }}" placeholder="Masukkan link youtube video profil">
                                    @error('video')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100">
                            ...
                            <div class="w-100">
                                <input type="text" name="map" id="map" class="@error('map') is-invalid @enderror" value="{{ old('map', $desaWisataItem->map) }}" required placeholder="Masukkan link google map">
                                @error('map')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image" class="@error('image') is-invalid @enderror" value="{{ old('image', $desaWisataItem->image) }}" onchange="previewImage()">
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    ...
                    @endif
                        <form action="/admin/desa-wisata-images/{{ $desaWisataItem->id }}" method="POST" class="" enctype="multipart/form-data">
                            @csrf
                            <div class="">
                    ...
                    <div class="pt-3">
                        ...
                        @if (isset($desaWisataItem->image) || (isset($other_images) && (is_array($other_images) || is_object($other_images)) && count($other_images)) > 0)
                        <div class="pt-3 w-100 d-md-flex gap-2">
                            <div class="image-list pe-md-4 me-md-3 pb-2 mb-3 border-end">
                                <div class="image-item ">
                                    <div class="image-card mb-1">
                                        <img src="{{ asset('storage/' . $desaWisataItem->image) }}" alt="">
                                    </div>
                                    Gambar Utama
                                </div>
                            </div>
                            <div class="image-list">
                                @foreach ($other_images as $other_image)
                                        ...
                                        <div class="image-item">
                                            ...
                                            <form
                                                action="{{ route('admin.desawisataimages.destroy', $other_image->id) }}"
                                                method="POST"

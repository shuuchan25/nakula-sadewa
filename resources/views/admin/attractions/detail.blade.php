    ...
    <section class="page-section">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="row w-100 d-flex align-items-start justify-content-between border-bottom">
                    <div class="col-12 col-md-6 ">
                        ...
                        <div class="pb-3">
                            <h5>Kategori</h5>
                            <p>{{ optional($attraction->category)->name }} ({{ optional($attraction->subCategory)->name }})
                            </p>
                        </div>
                        <div class="pb-3">
                            <h5>Harga</h5>
            ...
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-3 pb-2 pt-5">
                ...
                @can('admin-atraksi')
                    <button type="button" class="second-button"
                        onclick="location.href='/admin/attractions/{{ $attraction->slug }}/packages/create'">Tambah
                        Paket</button>
                @endcan
            </div>
                                    ...
                                    <tr class="table-item">
                                        <td class="">
                                            <div class="first-column">
                                                <p class="first-p">{{ $attractionPackage->name }}</p>
                                            </div>
                                        </td>
                                ...
                                @foreach ($attractionPackages as $attractionPackage)
                                    <tr class="table-item">
                                        ...
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/attractions/{{ $attraction->slug }}/packages/{{ $attractionPackage->slug }}'">
                                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M9 4.45962C9.91153 4.16968 10.9104 4 12 4C16.1819 4 19.028 6.49956 20.7251 8.70433C21.575 9.80853 22 10.3606 22 12C22 13.6394 21.575 14.1915 20.7251 15.2957C19.028 17.5004 16.1819 20 12 20C7.81811 20 4.97196 17.5004 3.27489 15.2957C2.42496 14.1915 2 13.6394 2 12C2 10.3606 2.42496 9.80853 3.27489 8.70433C3.75612 8.07914 4.32973 7.43025 5 6.82137"
                                                ...
                                                {{-- @can('admin-atraksi') --}}
                                                <button class=""
                                                    onclick="location.href='/admin/attractions/{{ $attraction->slug }}/packages/{{ $attractionPackage->slug }}/edit'">

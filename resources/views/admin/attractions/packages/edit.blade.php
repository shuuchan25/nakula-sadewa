        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                    ...
                    <form action="/admin/attractions/{{ $attraction->slug }}/packages/{{ $attractionPackage->slug }}"
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name" class=""
                                        value="{{ old('name', $attractionPackage->name) }}" placeholder="Nama Paket">
                                </div>
                            </div>
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        ...
                                        value="{{ old('image', $attractionPackage->image) }}" onchange="previewImage()">
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="description" id="description"
                                value="{{ old('description', $attractionPackage->description) }}">
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="w-100 pt-3 mt-3 border-top">
                                    ...
                                    <div class="d-md-flex w-100 align-items-center justify-content-between gap-3">
                                        <div class="w-100">
                                            <input type="file" name="other_image[]" id="other_image" class="file-input"
                                                onchange="previewImages()" multiple>
                                        </div>
                    ...
                    <div class="">
                        ...
                        @if (isset($attractionPackage->image) ||
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2 align-items-start">
                                <div class="image-item mb-2 mb-md-0">
                                    <div class="image-card mb-1">
                                        <img src="{{ asset('storage/' . $attractionPackage->image) }}" alt="">
                                    </div>
                                    Gambar Utama
                                </div>
                                @foreach ($attractionPackage->images as $other_image)
                                    <div class="image-item">
                                        ...
                                        <form
                                            action="/admin/attractions/{{ $attraction->slug }}/package-images/{{ $other_image->id }}"
                                            method="POST"
            ...
            <script>
                ...
                name.addEventListener('change', function() {
                    fetch('/admin/attractions/packages/checkSlug?name=' + name.value)

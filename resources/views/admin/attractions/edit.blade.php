        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/attractions/{{ $attraction->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $attraction->name) }}" required placeholder="Nama Atraksi">
                                    @error('name')
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        value="{{ old('slug', $attraction->slug) }}" required placeholder="Slug Atraksi">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <select name="sub_category_id" id="subCategorySelect">
                                        @foreach ($subCategories->where('category_id', $attraction->category_id) as $subCategory)
                                            @if (old('sub_category_id', $attraction->sub_category_id) == $subCategory->id)
                                                <option value="{{ $subCategory->id }}" selected>{{ $subCategory->name }}
                                                </option>
                                            @else
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    <div class="modal-body add-form pb-3">
                        ...
                        @endif
                        <form action="/admin/attraction-images/{{ $attraction->id }}" method="POST" class=""
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2 align-items-start">
                                ...
                                @foreach ($other_images as $other_image)
                                    <div class="image-item">
                                        ...
                                        <form action="{{ route('admin.attractionimages.destroy', $other_image->id) }}"
                                            method="POST"

...
@section('content')
    <section class="page-section">
                    ...
                    @can('admin-atraksi')
                        @if (!$attraction)
                            <button type="button" class="primary-button"
                                onclick="location.href='/admin/attractions/create'">Tambah
                                Atraksi</button>
                        @endif
                    @endcan
                </div>
                                    ...
                                    <tr class="table-item">
                                        ...
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/attractions/{{ $attraction->slug }}'">
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="">
                                        <div class="action-buttons">
                                            @can('admin-atraksi')
                                                <button class=""
                                                    onclick="location.href='/admin/attractions/{{ $attraction->slug }}/packages/create'">
                                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('admin-atraksi')
                                                <button class=""
                                                    onclick="location.href='/admin/attractions/{{ $attraction->slug }}/edit'">
                    ...
                    if (categoryId !== '') {
                        fetch('/get-subcategories/' + categoryId)
                            ...
                            .then(data => {
                                ...
                                const subCategoryIdFromUrl = new URLSearchParams(window.location.search)
                                    .get('sub_category_id');
        ...
        <script>
            const selectBox = document.querySelector('.select-2 select');

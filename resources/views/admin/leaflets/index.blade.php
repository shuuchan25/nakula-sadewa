    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-block d-md-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/leaflets/create'">Tambah Leaflet</button>
                </div>
            </div>
                                ...
                                <tr class="table-item">
                                    <td class="">
                                        <div class="first-column">
                                            <div class="">
                                                <h5><b>{{ $leaflet->name }}</b></h5>
                                                <p><a href="">{{ $leaflet->link }}</a></p>
                                            </div>
                                        </div>
                                        </td>
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/leaflets/{{ $leaflet->slug }}/edit'">
                                                ...
                                                <form action="/admin/leaflets/{{ $leaflet->slug }}" method="POST"
        ...
        <div class="pagination d-flex justify-content-center pt-4">
            {{ $leaflets->links('admin.partials.custom_pagination') }}
        </div>
    </section>
@endsection
...
<script>
    $(document).ready(function () {
        $('#search-input').on('input', function () {
            ...
            if (query.length >= 2) {
                $.ajax({
                    url: '/admin/leaflets', // Gunakan rute yang sama dengan halaman index
                    method: 'GET',
                    data: { search: query },

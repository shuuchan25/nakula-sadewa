            ...
            <div class="content-wrapper">
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $hotel->name) }}"
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $hotel->slug) }}"
                                ...
                                <div class="w-100 ">
                                    ...
                                    <div class="w-100">
                                        <input type="text" name="map" id="map"
                                            ...
                                            value="{{ old('map', $hotel->map) }}" required
                ...
                <div class="w-100 pt-3 mt-3 border-top">
                    ...
                    <div class="modal-body add-form pb-3">
                        <form action="/admin/hotel-images/{{ $hotel->id }}" method="POST" class=""

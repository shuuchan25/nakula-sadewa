        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/hotels/{{ $hotel->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name" class="@error('name') is-invalid @enderror" value="{{ old('name', $hotel->name) }}" required placeholder="Nama Destinasi Wisata">
                                    @error('name')
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug" class="@error('slug') is-invalid @enderror" value="{{ old('slug', $hotel->slug) }}" required placeholder="Slug Destinasi Wisata">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address" class="@error('address') is-invalid @enderror" value="{{ old('address', $hotel->address) }}" required placeholder="Masukkan alamat">
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact" class="@error('contact') is-invalid @enderror" value="{{ old('contact', $hotel->contact) }}" required placeholder="Masukkan nomor telepon">
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map" class="@error('map') is-invalid @enderror" value="{{ old('map', $hotel->map) }}" required placeholder="Masukkan link google map">
                                    @error('map')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            <div class="w-100 pt-3">
                                ...
                                <input type="hidden" name="description" id="description" value="{{ old('description', $hotel->description) }}">
                                @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                ...
                <div class="w-100 pt-3 border-top">
                    ...
                    <div class="">
                        ...
                        @if (isset($hotel->image) || (isset($other_images) && (is_array($other_images) || is_object($other_images)) && count($other_images)) > 0)

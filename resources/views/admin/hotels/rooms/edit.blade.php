                        ...
                        <div class="pt-3">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="w-100">
                                        <input type="text" name="name" id="name"
                                            ...
                                            value="{{ old('name', $hotelRoom->name) }}" required placeholder="Nama Kamar">
                                        @error('name')
                                ...
                                <div class="w-100 pt-3 pt-md-0">
                                    ...
                                    <div class="w-100">
                                        <input type="text" name="slug" id="slug"
                                            ...
                                            value="{{ old('slug', $hotelRoom->slug) }}" required placeholder="Slug Kamar">
                                        @error('slug')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="w-100">
                                        <input type="number" name="price" id="price"
                                            ...
                                            value="{{ old('price', $hotelRoom->price) }}" required
                                ...
                                <div class="w-100 pt-3 pt-md-0">
                                    ...
                                    <div class="w-100">
                                        <input type="number" name="capacity" id="capacity"
                                            ...
                                            value="{{ old('capacity', $hotelRoom->capacity) }}" required
                            ...
                            <div class="w-100 pt-3">
                                ...
                                <input type="hidden" name="description" id="description"
                                    value="{{ old('description', $hotelRoom->description) }}">
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2">
                                @foreach ($roomImages as $roomImage)
                                    <div class="image-item">
                                        ...
                                        <form action="/admin/hotels/{{ $hotel->slug }}/room-images/{{ $roomImage->id }}"
                                            method="POST"

                        ...
                        @if ($hotelRooms->count() > 0)
                            <table id="table-container" class="">
                                <tr class="bg-[#F6F6F6] text-sm ">
                                    <th class="col-one">Nama Kamar</th>
                                    ...
                                    <tr class="table-item">
                                        <td class="">
                                            <div class="first-column">
                                                <p class="first-p">{{ $hotelRoom->name }}</p>
                                            </div>
                                        </td>
                                        <td class="">Rp{{ number_format($hotelRoom->price, 0, ',', '.') }}</td>
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/hotels/{{ $hotel->slug }}/rooms/{{ $hotelRoom->slug }}/detail'">
                                ...
                                @foreach ($hotelRooms as $hotelRoom)
                                    <tr class="table-item">
                                        ...
                                        <td class="">
                                            <div class="action-buttons">
                                                <button class=""
                                                    onclick="location.href='/admin/hotels/{{ $hotel->slug }}/rooms/{{ $hotelRoom->slug }}'">
                                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M9 4.45962C9.91153 4.16968 10.9104 4 12 4C16.1819 4 19.028 6.49956 20.7251 8.70433C21.575 9.80853 22 10.3606 22 12C22 13.6394 21.575 14.1915 20.7251 15.2957C19.028 17.5004 16.1819 20 12 20C7.81811 20 4.97196 17.5004 3.27489 15.2957C2.42496 14.1915 2 13.6394 2 12C2 10.3606 2.42496 9.80853 3.27489 8.70433C3.75612 8.07914 4.32973 7.43025 5 6.82137"
                                                ...
                                                @can('admin-akomodasi')
                                                    <button class=""
                                                        onclick="location.href='/admin/hotels/{{ $hotel->slug }}/rooms/{{ $hotelRoom->slug }}/edit'">
                                                    ...
                                                    <form action="/admin/hotels/{{ $hotel->slug }}/rooms/{{ $hotelRoom->slug }}"
                                                        method="POST"

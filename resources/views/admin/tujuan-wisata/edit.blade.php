        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/tujuan-wisata/{{ $tujuanWisataItem->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name" class="@error('name') is-invalid @enderror" value="{{ old('name', $tujuanWisataItem->name) }}" required placeholder="Nama Destinasi Wisata">
                                    @error('name')
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug" class="@error('slug') is-invalid @enderror" value="{{ old('slug', $tujuanWisataItem->slug) }}" required placeholder="Slug Destinasi Wisata">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour" class="@error('operational_hour') is-invalid @enderror" value="{{ old('operational_hour', $tujuanWisataItem->operational_hour ) }}" required placeholder="Contoh 08.00 - 17.00">
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address" class="@error('address') is-invalid @enderror" value="{{ old('address', $tujuanWisataItem->address) }}" required placeholder="Masukkan alamat">
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="number" name="price" id="price" class="@error('price') is-invalid @enderror" value="{{ old('price', $tujuanWisataItem->price) }}" required placeholder="Masukkan harga">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact" class="@error('contact') is-invalid @enderror" value="{{ old('contact', $tujuanWisataItem->contact) }}" required placeholder="Masukkan nomor telepon">
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map" class="@error('map') is-invalid @enderror" value="{{ old('map', $tujuanWisataItem->map) }}" required placeholder="Masukkan link google map">
                                    @error('map')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="video" id="video" class="@error('video') is-invalid @enderror" value="{{ old('video', $tujuanWisataItem->video) }}" placeholder="Masukkan link youtube video profil">
                                    @error('video')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="d-flex w-100 gap-3 align-items-center justify-content-between pt-3">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="coordinate_x" id="coordinate_x" class="@error('coordinate_x') is-invalid @enderror" value="{{ old('coordinate_x', $tujuanWisataItem->coordinate_x) }}" required placeholder="Masukkan koordinat (Latitude)">
                                    @error('coordinate_x')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="coordinate_y" id="coordinate_y" class="@error('coordinate_y') is-invalid @enderror" value="{{ old('coordinate_y', $tujuanWisataItem->coordinate_y) }}" required placeholder="Masukkan koordinat (Longitude)">
                                    @error('coordinate_y')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="description" id="description" value="{{ old('description', $tujuanWisataItem->description) }}">
                            @error('other_image')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="w-100 pt-3 border-top">
                    ...
                    <div class="modal-body add-form pb-3">
                        <form action="/admin/tujuan-wisata-images/{{ $tujuanWisataItem->id }}" method="POST" class="" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="">
                        ...
                        @if (isset($tujuanWisataItem->image) || (isset($other_images) && (is_array($other_images) || is_object($other_images)) && count($other_images)) > 0)
                            <div class="image-list pt-3 w-100 d-flex gap-2">
                                ...
                                <div class="image-item">
                                    ...
                                    <form action="{{ route('admin.tujuanwisataimages.destroy', $other_image->id) }}"

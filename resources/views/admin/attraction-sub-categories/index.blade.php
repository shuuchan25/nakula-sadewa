                ...
                <div class="">
                    @can('superadmin')
                        <button type="button" class="primary-button"
                            onclick="location.href='/admin/attraction-sub-categories/create'">Tambah Sub Kategori</button>
                    @endcan
                </div>
            </div>
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="">
                                        <div class="action-buttons">
                                            @can('superadmin')
                                                <button class=""
                                                    onclick="location.href='/admin/attraction-sub-categories/{{ $attractionSubCategory->slug }}/edit'">
                                                ...
                                                <form
                                                    action="/admin/attraction-sub-categories/{{ $attractionSubCategory->slug }}"
                                                    method="POST"

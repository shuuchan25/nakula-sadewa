    ...
    <div id="sidebarMenu" class="sidebar-menu">
        <div class="w-100">
            ...
            <div class="menu-buttons">
                ...
                <div class="">
                    <button
                        class="{{ Request::is('admin/hotels*') || Request::is('admin/kategori-hotel*') ? 'active-menu' : '' }}" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse ps-2" id="dropdownHotel">
                        <ul class="list-unstyled">
                            ...
                            <button onclick="location.href='/admin/kategori-hotel'"
                                class="{{ Request::is('admin/kategori-hotel*') ? 'active-menu' : '' }} mt-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

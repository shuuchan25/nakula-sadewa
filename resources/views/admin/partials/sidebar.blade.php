    ...
    <div id="sidebarMenu" class="sidebar-menu">
        <div class="w-100">
            ...
            <div class="menu-buttons">
                ...
                <div class="border border-white w-100 mb-2"></div>
                            ...
                            <ul class="list-unstyled">
                                <button onclick="location.href='/admin/webprofile'"
                                    ...
                                    <svg fill="currentColor" width="22" height="22" viewBox="0 0 52 52"
                                        ...
                                        <path
                                            d="M26,43.86a2,2,0,0,1-2-2V22.66a2,2,0,1,1,4,0v19.2A2,2,0,0,1,26,43.86Z" />
                            ...
                            <ul class="list-unstyled">
                                ...
                                <button onclick="location.href='/admin/events'"
                                    ...
                                    <svg width="22" viewBox="0 0 20 20" version="1.1"
                                        ...
                                        <title>time / 27 - time, calendar, time, date, event, planner, shedule, task
                                            icon
                                        </title>
        ...
        <div class="bottom-menu">
            ...
            <button onclick="location.href='/admin/users/{{ auth()->user()->username }}/edit'" class="profile">
                <div class="profile-photo">
                    @if (auth()->user()->image)
                        <img src="{{ Storage::url(auth()->user()->image) }}" class="object-fit-cover"
                            style="width: 40px; height: 40px" alt="" id=''>
                    @else
        ...
        dropdownButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                dropdownButtons.forEach(otherButton => {
                    if (otherButton !== this) {
                        const collapseTarget = document.querySelector(otherButton.getAttribute(
                            'data-bs-target'));

        ...
        <div class="w-100">
            ...
            <div class="menu-buttons">
                    ...
                    <div class="collapse ps-2" id="dropdownExample">
                        <ul class="list-unstyled">
                            <button onclick="location.href='/admin/webprofile'"
                                ...
                                <svg fill="currentColor" width="22" height="22" viewBox="0 0 52 52"
                            ...
                            <button onclick="location.href='/admin/leaflets'"
                                class="{{ Request::is('admin/leaflets*') ? 'active-menu' : '' }}">
                                <svg width="23px" height="23px" viewBox="-0.5 0 21 21" version="1.1"
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round" />
                                <path d="M17 13.4H13.8C11.4 13.4 10.6 12.6 10.6 10.2V7L17 13.4Z" stroke="currentColor"
                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.6 2H15.6" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M7 5C7 3.34 8.34 2 10 2H12.62" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M21.9999 8V14.19C21.9999 15.74 20.7399 17 19.1899 17" stroke="currentColor"
                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="collapse ps-2" id="dropdownKonten">
                        <ul class="list-unstyled">
                            ...
                            <button onclick="location.href='/admin/guides'"
                                ...
                                <svg width="24" viewBox="0 0 24 24" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="dropdown">
                    ...
                    <div class="collapse ps-2" id="dropdownMap">
                        <ul class="list-unstyled">
                            <button onclick="location.href='/admin/maps'"
                                class="{{ Request::is('admin/maps*') ? 'active-menu' : '' }} mt-2">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.7 15C4.03377 15.6353 3 16.5205 3 17.4997C3 19.4329 7.02944 21 12 21C16.9706 21 21 19.4329 21 17.4997C21 16.5205 19.9662 15.6353 18.3 15M12 9H12.01M18 9C18 13.0637 13.5 15 12 18C10.5 15 6 13.0637 6 9C6 5.68629 8.68629 3 12 3C15.3137 3 18 5.68629 18 9ZM13 9C13 9.55228 12.5523 10 12 10C11.4477 10 11 9.55228 11 9C11 8.44772 11.4477 8 12 8C12.5523 8 13 8.44772 13 9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                Penanda Lokasi
                            </button>
                            <button onclick="location.href='/admin/map-categories'"
                                class="{{ Request::is('admin/map-categories*') ? 'active-menu' : '' }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="">
                    <button
                        ...
                        <div class="d-flex gap-3">
                            <svg fill="currentColor" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19.35,8.84a4.781,4.781,0,0,0-3.239-4.356,4.167,4.167,0,0,0-8.222,0A4.78,4.78,0,0,0,4.649,8.84,4.234,4.234,0,0,0,6.176,17H11v4H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2H13V17h4.823A4.234,4.234,0,0,0,19.35,8.84ZM17.823,15H13V13.414l2.707-2.707a1,1,0,0,0-1.414-1.414L13,10.586V8a1,1,0,0,0-2,0v2.586L9.707,9.293a1,1,0,0,0-1.414,1.414L11,13.414V15H6.176a2.228,2.228,0,0,1-.321-4.424,1,1,0,0,0,.838-1.142,2.735,2.735,0,0,1,2.279-3.16,1,1,0,0,0,.857-.989c0-.026,0-.06-.005-.094a2.176,2.176,0,1,1,4.352-.008c0,.018,0,.036,0,.049a1,1,0,0,0,.855,1.042,2.736,2.736,0,0,1,2.28,3.163,1,1,0,0,0,.838,1.139A2.228,2.228,0,0,1,17.823,15Z"/></svg>
                            Atraksi
                        </div>
                        <svg class="select-box__icon" width="26" height="26" viewBox="0 0 26 26"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @if(auth()->user()->role->name === 'Admin Toko' || auth()->user()->role->name === 'Superadmin')
                <button onclick="location.href='/admin/shops'"
                    class="{{ Request::is('admin/shops*') ? 'active-menu' : '' }}">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @if(auth()->user()->role->name === 'Superadmin')
                <button onclick="location.href='/admin/transactions'"
                    class="{{ Request::is('admin/transactions*') ? 'active-menu' : '' }}">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M18 8.49998H14M18 14.5H14M18 17.5H14M10 8.49999H8M8 8.49999L6 8.49999M8 8.49999L8 6.49998M8 8.49999L8 10.5M9.5 14.5L8.00001 16M8.00001 16L6.50001 17.5M8.00001 16L6.5 14.5M8.00001 16L9.49999 17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                        </svg>
                    Transaksi
                </button>
                @endif

    ...
    <section class="page-section">
        ...
        <div class="page-content d-flex flex-column align-items-center">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-4 pb-2 w-100">
                ...
                <div class="">
                    @can('superadmin')
                        <button type="button" class="primary-button" onclick="location.href='/admin/kategori-hotel/create'">Tambah
                            Kategori</button>
                    @endcan
                </div>
            </div>
                                ...
                                <tr class="table-item">
                                    <td class="">
                                        <div class="first-column">
                                            <p class="first-p">{{ $hotelCategory->name }}</p>
                                        </div>
                </div>
                </td>
                <td class="">
                    <div class="action-buttons">
                        @can('superadmin')
                            <button class=""
                                onclick="location.href='/admin/kategori-hotel/{{ $hotelCategory->slug }}/edit'">

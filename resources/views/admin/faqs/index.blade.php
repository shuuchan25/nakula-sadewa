    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-3 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='/admin/faqs/create'">Tambah
                        FAQ</button>
                </div>
            </div>
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="">
                                        ...
                                        <path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z" stroke="currentColor" stroke-width="1.5"/>
                                            ...
                                            <button class=""
                                                onclick="location.href='/admin/faqs/{{ $faq->slug }}/edit'">
                                            ...
                                            <form action="/admin/faqs/{{ $faq->slug }}" method="POST"

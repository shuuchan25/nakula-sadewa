    ...
    <section class="page-section">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/maps" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="">
                                    <input type="text" name="coordinate_x" id="coordinate_x"
                                        ...
                                        value="{{ old('coordinate_x') }}" required>
                                    @error('coordinate_x')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100 pt-md-0 pt-3">
                                ...
                                <div class="">
                                    <input type="text" name="coordinate_y" id="coordinate_y"
                                        ...
                                        value="{{ old('coordinate_y') }}" required>
                                    @error('coordinate_y')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
        ...
        <script>
            ...
            name.addEventListener('change', function() {
                fetch('/admin/maps/checkSlug?name=' + name.value)

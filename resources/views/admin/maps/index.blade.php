                        ...
                        <table class="" id="table-container">
                            ...
                            @foreach ($maps as $map)
                                <tr class="table-item">
                                    ...
                                    <td>{{ $map->coordinate_y }}</td>
                                    <td class="">
                                        <div class="action-buttons">
                                            <button class=""
                                                onclick="location.href='/admin/maps/{{ $map->slug }}/edit'">
                                            ...
                                            <form action="/admin/maps/{{ $map->slug }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            $('#search-input').on('input', function() {
                ...
                if (query.length >= 2) {
                    $.ajax({
                        url: '/admin/maps', // Gunakan rute yang sama dengan halaman index
                        method: 'GET',
                        data: {
                            search: query
                        },

    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-sm-flex align-items-center justify-content-between pb-lg-4 pb-2">
                <div class="">
                    <p class="">Hai Admin,</p>
                    <h3 class="">Pusat Oleh-Oleh</h3>
                </div>
                <div class="">
                    @can('admin-toko')
                        <button type="button" class="primary-button" onclick="location.href='/admin/shops/create'">Tambah Toko</button>
                    @endcan
                </div>
            </div>
                ...
                <form action="/admin/shops" method="GET" id="search-form" class="w-100">
                    ...
                    <div class="item-filters">
                        <div class="search">
                            ...
                            <input type="text" name="search" class="" id="search-input" placeholder="Cari toko..." value="{{ request('search') }}">
                        </div>
                ...
                <div class="overflow-x-auto w-100">
                    ...
                    <table id="table-container" class="">
                        ...
                        <tr class="table-item">
                            ...
                            {{-- <td class="">{{ optional($shop->category)->name }}</td> --}}
                            {{-- <td class="">{{ $shop->address }}</td> --}}
                            <td class="">{{ $shop->contact }}</td>
                            <td class="">
                                <div class="action-buttons">
                                    @can('admin-toko')
                                    <button class="" onclick="location.href='/admin/shops/{{ $shop->slug }}/gifts/create'">
                                    ...
                                    @can('admin-toko')
                                    <button class="" onclick="location.href='/admin/shops/{{ $shop->slug }}/edit'">
                                    ...
                                    <form action="/admin/shops/{{ $shop->slug }}" method="POST"

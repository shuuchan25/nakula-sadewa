            ...
            <div class="content-wrapper">
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $shop->name) }}"
                                        required placeholder="Nama Wisata Kuliner">
                                    @error('name')
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $shop->slug) }}"
                                        required placeholder="Slug Wisata Kuliner">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address"
                                        ...
                                        value="{{ old('address', $shop->address) }}" required placeholder="Masukkan alamat">
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour"
                                        ...
                                        value="{{ old('operational_hour', $shop->operational_hour) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact"
                                        ...
                                        value="{{ old('contact', $shop->contact) }}" required
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map"
                                        class="@error('map') is-invalid @enderror" value="{{ old('map', $shop->map) }}"
                                        required placeholder="Masukkan link google map">
                                    @error('map')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        ...
                                        value="{{ old('image', $shop->image) }}" onchange="previewImage()">
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    <div class="modal-body add-form pb-3">
                        ...
                        @endif
                        <form action="/admin/shop-images/{{ $shop->id }}" method="POST" class=""
                            ...
                            <div class="image-list pt-3 w-100 d-flex gap-2 align-items-start">
                                ...
                                @foreach ($other_images as $other_image)
                                    <div class="image-item">
                                        ...
                                        <form action="{{ route('admin.shopimages.destroy', $other_image->id) }}"
                                            method="POST"

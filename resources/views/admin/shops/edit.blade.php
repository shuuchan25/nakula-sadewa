    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-3 pb-2">
                <div class="">
                    <p class="">Hai Admin,</p>
                    <h3 class="">Edit Toko</h3>
                </div>
            </div>
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/shops/{{ $shop->slug }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $shop->name) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $shop->slug ) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="address" id="address"
                                        class="@error('address') is-invalid @enderror" value="{{ old('address', $shop->address ) }}"
                            ...
                            <div class="w-100" >
                                ...
                                <div class="w-100">
                                    <input type="text" name="operational_hour" id="operational_hour"
                                        ...
                                        value="{{ old('operational_hour', $shop->operational_hour ) }}" required placeholder="Contoh 08.00 - 17.00">
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="contact" id="contact"
                                        class="@error('contact') is-invalid @enderror" value="{{ old('contact', $shop->contact) }}"
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="map" id="map"
                                        class="@error('map') is-invalid @enderror" value="{{ old('map', $shop->map) }}" required
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        class="@error('image') is-invalid @enderror" value="{{ old('image', $shop->image) }}"
                        ...
                        <div class="w-100 pt-3">
                            ...
                            <input type="hidden" name="description" id="description" value="{{ old('description', $shop->description ) }}">
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="w-100 pt-2 border-top mt-3">
                    <div class="modal-body add-form pb-3">
                        ...
                        @endif
                        <form action="/admin/shop-images/{{ $shop->id }}" method="POST"
                                ...
                                <div class="image-list pt-3 pt-md-0">
                                    @foreach ($other_images as $other_image)
                                            ...
                                            <div class="image-item">
                                                ...
                                                <form
                                                    action="{{ route('admin.shopimages.destroy', $other_image->id) }}"
                                                    method="POST"
        ...
        <script>
            ...
            name.addEventListener('change', function() {
                fetch('/admin/shops/checkSlug?name=' + name.value)

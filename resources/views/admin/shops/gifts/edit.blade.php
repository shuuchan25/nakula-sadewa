        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/shops/{{ $shop->slug }}/gifts/{{ $gift->slug }}" method="POST" class=""
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name"
                                        class="@error('name') is-invalid @enderror" value="{{ old('name', $gift->name) }}"
                                        required placeholder="Nama Oleh-oleh">
                                    @error('name')
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug"
                                        class="@error('slug') is-invalid @enderror" value="{{ old('slug', $gift->slug) }}"
                                        required placeholder="Slug Oleh-oleh">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="number" name="price" id="price"
                                        ...
                                        value="{{ old('price', $gift->price) }}" required placeholder="Masukkan harga">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="file" name="image" id="image"
                                        ...
                                        value="{{ old('image', $gift->image) }}" onchange="previewImage()">
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>

        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="modal-body add-form">
                    <form action="/admin/shops/{{ $shop->slug }}/gifts" method="POSt" class="" enctype="multipart/form-data">
                        @csrf
                        <div id="menu-list">
                        </div>
                        <div class="d-md-flex w-100 gap-3 align-items-center justify-content-between">
                            <div class="w-100">
                                ...
                                <div class="w-100">
                                    <input type="text" name="name" id="name" class="@error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Nama Oleh-Oleh">
                                    @error('name')
                            ...
                            <div class="w-100 pt-3 pt-md-0">
                                ...
                                <div class="w-100">
                                    <input type="text" name="slug" id="slug" class="@error('slug') is-invalid @enderror" value="{{ old('slug') }}" required placeholder="Slug Oleh-Oleh">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>

    ...
    <section class="page-section">
        ...
        <div class="page-content">
                ...
                <div class="d-flex gap-sm-3 gap-2 flex-wrap align-items-center justify-content-end">
                    ...
                    @can('admin-toko')
                        <button type="button" class="second-button"
                            onclick="location.href='/admin/shops/{{ $shop->slug }}/edit'">Edit</button>
                    @endcan
                </div>
            </div>
            ...
            <div class="content-wrapper pb-4">
                <form action="/admin/shops/{{ $shop->slug }}" method="GET" id="search-form" class="w-100">
                ...
                <div class="w-100 overflow-x-auto">
                    @if ($gifts->count() > 0)
                        @foreach ($gifts as $gift)
                            <div
                                class="gap-md-4 gap-2 w-100 d-md-flex align-items-center justify-content-between border-bottom pb-3 pt-3">

                                <div class="">
                                    <div class="image-card">
                                        <img src="{{ Storage::url($gift->image) }}" alt="">
                                    </div>
                                </div>
                                <div class="w-100 d-flex align-items-end justify-content-between gap-4">
                                    <div class="">
                                        <div class="">
                                            <h5 class="mb-1">{{ $gift->name }}</h5>
                                            <p class="mb-2">Rp{{ number_format($gift->price, 0, ',', '.') }}</p>
                                        </div>
                                    ...
                                    <div class="action-buttons">
                                        <div class="">
                                            @can('admin-toko')
                                                <button class=""
                                                    onclick="location.href='/admin/shops/{{ $shop->slug }}/gifts/{{ $gift->slug }}/edit'">

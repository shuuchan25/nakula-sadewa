    ...
    <section class="page-section">
        ...
        <div class="page-content">
            <div class="header d-flex align-items-center justify-content-between pb-lg-4 pb-2">
                ...
                <div class="">
                    <button type="button" class="primary-button" onclick="location.href='add-culinary'">Tambah
                        Kuliner</button>
                </div>
            </div>
            <div class="content-wrapper">
                        ...
                        <tr class="table-item">
                            <td class="">
                                <div class="first-column">
                                    <p class="first-p">Kuliner Pandean</p>
                                </div>
                </div>
                </td>
                <td class="">Alamat</td>
                ...
                <td class="">
                    <div class="action-buttons">
                        <button class="" onclick="location.href='add-menu'">
                        ...
                        <button class="" onclick="location.href='detail-culinary'">
                        ...
                        <button class="" onclick="location.href='edit-culinary'">

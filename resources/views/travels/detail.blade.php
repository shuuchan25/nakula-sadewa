        ...
        <div class="row toggle-paket-wisata">
            <div class="col my-auto">
                ...
                <div class="row input-amount ">
                    ...
                    <div class="button-add-amount my-auto mt-3">
            ...
            <div class="col my-auto">
                <div class="row input-amount ">
                    <div class="button-hubungi justify-content-end my-auto">
                        <button onclick="window.location='/travels/{{ $travelMenu->travel->slug }}/profile'" class="btn-hubungi">Kunjungi Layanan Biro</button>
                    </div>
                    {{-- <div class="button-hubungi justify-content-end my-auto mt-3">
                            <button class="btn-hubungi">

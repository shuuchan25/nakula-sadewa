...
<nav class="navbar navbar-expand-lg" style="position: fixed; top: 0;left: 0; ">
    <div class="container">
        ...
        <div class="collapse navbar-collapse w-100" id="navbar-menus" style="justify-content: end" onclick="toggleNavbar()">
            <div class="navbar-nav" id="navbarNav">
                <a class="nav-link active" href="/">Beranda</a>    {{-- {{ Request::is('welcome')  ? 'active-nav' : '' }} --}}

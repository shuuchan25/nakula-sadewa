                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-3">
                        <ul class="nav justify-content-center gap-5">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="rumahmakan">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="travels/index">

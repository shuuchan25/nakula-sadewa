                    ...
                    <div class="tabs rounded">
                        <ul class="nav nav-tabs border-0 justify-content-center gap-2">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link category-tab link" id="all-tab" data-bs-toggle="tab"
                                        ...
                                        @foreach ($subCategories as $index => $subCategory)
                                            <li class="nav-item">
                                                <a class="nav-link sub-category-tab {{ $activeSubCategory == $subCategory->id ? 'active' : '' }}"
                                                    ...
                                                    role="tab"
                                                    aria-selected="{{ $activeSubCategory ? 'true' : '' }}">{{ $subCategory->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                    {{-- tab content pills --}}
                        ...
                        <!-- Tab panes  -->
                        <div class="bg-section pt-4 pb-5">
                            <div class="tab-pane fade active" id="all-tab-pane">
                                {{-- tab content --}}
                                <div class="tab-content" id="myTabContent">
                                    <form action="/attractions" method="GET" id="search-form" class="w-100">
                                        <div class="container search-all">

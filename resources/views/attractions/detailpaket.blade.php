    ...
    <div class="page-content">
        ...
        <div class="bd-content">
                ...
                <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="text-decoration:none"
                                href="/attractions/{{ $attraction->slug }}">{{ $attraction->name }}</a></li>
            ...
            <div class="container mb-5">
                <div class="harga mt-5" style="text-align: center">
                    <h4>Harga</h4>
                ...
                <div class="row toggle-paket-wisata">
                    {{-- <div class="col my-auto"> --}}
                        <form action="/packages/{{ $attractionPackage->slug }}" method="POST">
                            ...
                            <div class="row input-amount justify-content-center d-flex">
                                <div class="col-md-5 my-auto justify-content-center d-flex">
                                ...
                                <div class="button-add-amount my-auto d-flex justify-content-center">
                                    <button type="submit" class="add-button">Tambahkan</button>
                                </div>
                            </div>
                        </form>
                        <div class="button-hubungi my-auto d-flex justify-content-center mt-4">

...
<div class="container category">
    <div class="card menubar border-0 shadow-sm rounded-3">
        {{-- <div class="card-body"> --}}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                            <path d="M1 1H19" stroke="#AC0B05" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M16.3003 1H3.70029C3.20324 1 2.80029 1.42901 2.80029 1.95822V19.2062C2.80029 19.7354 3.20324 20.1644 3.70029 20.1644H16.3003C16.7973 20.1644 17.2003 19.7354 17.2003 19.2062V1.95822C17.2003 1.42901 16.7973 1 16.3003 1Z" stroke="#AC0B05" stroke-width="2" stroke-linejoin="round"/>
                            <path d="M8.2002 14.415H11.8002V20.1644H8.2002V14.415Z" stroke="#AC0B05" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M5.94971 4.83301H6.84971M5.94971 7.70767H6.84971M9.54971 4.83301H10.4497M9.54971 7.70767H10.4497M13.1497 4.83301H14.0497M13.1497 7.70767H14.0497" stroke="#AC0B05" stroke-width="2" stroke-linecap="round"/>
                            <path d="M1 20.164H19M11.8 14.4147H12.7C12.9484 14.4147 13.1545 14.1981 13.1068 13.9385C12.8584 12.5778 11.5619 11.54 10 11.54C8.4385 11.54 7.1416 12.5773 6.8932 13.9385C6.8455 14.1981 7.0516 14.4147 7.3 14.4147H8.2" stroke="#AC0B05" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    Penginapan</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md menubar">
            <div class="menu d-flex justify-content-center align-items-center mx-auto gap-5">
                <div class="d-flex justify-content-center align-items-center">
                    <svg width="18" height="15" viewBox="0 0 54 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.18604 45.1679H50.8138L32.5009 6.50476C32.0079 5.46288 31.2292 4.58243 30.2553 3.96587C29.2815 3.3493 28.1525 3.02197 26.9999 3.02197C25.8473 3.02197 24.7183 3.3493 23.7445 3.96587C22.7706 4.58243 21.9919 5.46288 21.4989 6.50476L3.18604 45.1679Z" stroke="#FCB600" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.093 21.354L20.385 27.969L27 21.354L32.2919 29.292L38.9069 24" stroke="#FCB600" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <a class="nav-link" href="#">

...
$(document).on("click", ".card-dropdown .btn-card-dropdown", function (e) {
    e.preventDefault();
    $(this)
        .parents(".card-dropdown")
        .find(".card-dropdown-content")
        .toggleClass("show");
});

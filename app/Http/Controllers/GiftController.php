...
class GiftController extends Controller
{
    ...
    public function store(Request $request, $slug)
    {
        ...
        return redirect('/admin/shops/' . $shop->slug)->with('success', 'Menu baru berhasil dibuat!');
    }
    ...
    public function update($slug, Request $request, Gift $gift)
    {
        ...
        return redirect('/admin/shops/' . $shop->slug)->with('success', 'Menu berhasil diperbarui!');
    }
    ...
    public function destroy($slug, Gift $gift)
    {
        ...
        return redirect('/admin/shops/' . $shop->slug)->with('success', 'Menu berhasil dihapus!');
    }

...
class EventImageController extends Controller
{
    public function store(Request $request, $id)
    {
        ...
        return redirect('/admin/events/' . $event->slug . '/edit')->with('success', 'Gambar Penginapan berhasil ditambahkan');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/events/' . $event->slug . '/edit')->with('success', 'Gambar Penginapan berhasil dihapus');
    }
}
